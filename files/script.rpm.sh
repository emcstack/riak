...
main ()
{
  ...
  yum_repo_config_url="https://packagecloud.io/install/repositories/basho/riak/config_file.repo?os=${os}&dist=${dist}&source=script"
...
## Created by packagecloud.io https://packagecloud.io/basho/riak/install
